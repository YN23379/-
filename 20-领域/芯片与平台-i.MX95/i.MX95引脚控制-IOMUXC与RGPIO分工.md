...
>
> **注意 J15-8/J15-10 是 FRDM-IMX95-PRO 板的位置。** i.MX95 19x19 EVK 上这两个脚
> **没有引到任何排针**，只在板对板连接器 J3 的 42/44 脚上（`UM12022` Table 58），
> 再往下接 FT4232H 通道 A → USB-C → PC 串口。两块板的设计符号还重名（EVK 的 J15 是 Mini-SAS）。
>
