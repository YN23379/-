...
| **`UART与GPIO验证方案.md`** | **inmate 到底拿到了哪些资源（cell 逐段解码）、UART 收发 + GPIO 输入输出怎么验、踩过的四个坑** |
| **`第二阶段资源与硬件方案.md`** | **这块板没有 GPIO 排针，LED/按键/I2C 传感器该怎么落；I2C6 = J22 = GPIO_IO02/03；第二阶段计划逐条改写** |
| `SAM9X60培训提问清单.md` | 2026-09-23 Microchip 培训提问清单（多核架构、资源隔离与权限分配的对比） |
